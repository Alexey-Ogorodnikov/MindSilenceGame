package com.mindsilence.game.feature.menu // Menu Route + Screen: training button and How to train.
...
import androidx.lifecycle.viewmodel.compose.viewModel // Default MenuViewModel factory.
...
fun MenuRoute( // AppRoute passes onOpenTraining; this screen never sees AppViewModel.
    onOpenTraining: () -> Unit, // Becomes AppUiEvent.OpenTraining in AppRoute.
    modifier: Modifier = Modifier, // Host fill.
    viewModel: MenuViewModel = viewModel(), // No factory args.
    ...
    MenuScreen( // Stateless layout + lambdas.
        ...
        onTrainingClick = { viewModel.onEvent(MenuUiEvent.OpenTraining) }, // Effect, not a state flag.
        onHowToTrainClick = { viewModel.onEvent(MenuUiEvent.OpenHowToTrain) }, // Open dialog.
        onDismissHowToTrain = { viewModel.onEvent(MenuUiEvent.DismissHowToTrain) }, // Close dialog.
