...
plugins { // plugins applied to the :app module
    ...
    alias(libs.plugins.hilt) // Hilt DI for Application, Activity, and ViewModels
    alias(libs.plugins.ksp) // KSP processes Hilt annotations (not kapt)
}

android { // Android application configuration
    namespace = "com.mindsilence.game" // R and BuildConfig package (same as MVI source packages)
    compileSdk = 36 // Android API used to compile

    defaultConfig { // shared settings for all build types
        applicationId = "com.mindsilence.game.mvvm" // Distinct install id so this APK can sit beside MVI
...
dependencies { // module classpath
    ...
    implementation(libs.hilt.android) // Hilt runtime annotations and generated components
    ksp(libs.hilt.compiler) // Generate Hilt factories and the Application component
    implementation(libs.androidx.hilt.navigation.compose) // hiltViewModel() without adding a NavHost
    ...
    reports { // coverage reports and verification
        filters { // which classes enter the coverage gate
            includes { // allowlist of classes that must be covered
                classes( // MVVM/domain types required to meet the line-coverage gate
                    "com.mindsilence.game.presentation.game.GameViewModel", // game session ViewModel
                    "com.mindsilence.game.presentation.game.GameUiState", // game screen state
                    "com.mindsilence.game.presentation.game.GameUiEffect*", // game one-shot effects
                    "com.mindsilence.game.domain.model.GamePhase", // in-session phase enum
                    "com.mindsilence.game.domain.model.SessionSummary", // post-session summary model
                    "com.mindsilence.game.domain.model.DailyStats", // daily stats model
                    "com.mindsilence.game.domain.usecase.LevelDurationKt", // level duration helpers
                    "com.mindsilence.game.domain.usecase.RecordSessionUseCase", // persist a finished attempt
                    "com.mindsilence.game.domain.usecase.GetDailyStatsUseCase", // load highscore rows
                    "com.mindsilence.game.domain.repository.GameProgressRepository", // progress persistence port
                    "com.mindsilence.game.data.SharedPreferencesGameProgressRepository", // SharedPreferences impl
                    "com.mindsilence.game.presentation.splash.SplashViewModel", // splash ViewModel
                    "com.mindsilence.game.presentation.splash.SplashUiState", // splash screen state
                    "com.mindsilence.game.presentation.splash.SplashDefaults", // splash timing defaults
                    "com.mindsilence.game.presentation.menu.MenuViewModel", // menu ViewModel
                    "com.mindsilence.game.presentation.menu.MenuUiState", // menu screen state
                    "com.mindsilence.game.presentation.menu.MenuUiEffect*", // menu one-shot effects
                    "com.mindsilence.game.presentation.highscores.HighScoresViewModel", // high scores ViewModel
                    "com.mindsilence.game.presentation.highscores.HighScoresUiState", // high scores screen state
                    "com.mindsilence.game.presentation.highscores.HighScoresUiEffect*", // high scores one-shot effects
                    "com.mindsilence.game.presentation.navigation.AppViewModel", // root navigation ViewModel
                    "com.mindsilence.game.presentation.navigation.AppUiState", // root navigation state
                )
            }
        }
