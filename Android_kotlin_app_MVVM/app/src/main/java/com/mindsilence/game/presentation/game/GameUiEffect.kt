package com.mindsilence.game.presentation.game // One-shot training effects for GameRoute.
...
sealed interface GameUiEffect { // Window flags and nav cannot live in UiState.
    ...
    data object NavigateToHighScores : GameUiEffect // AppViewModel.openHighScores().
    data object NavigateBackToMenu : GameUiEffect // AppViewModel.leaveTraining().
}
