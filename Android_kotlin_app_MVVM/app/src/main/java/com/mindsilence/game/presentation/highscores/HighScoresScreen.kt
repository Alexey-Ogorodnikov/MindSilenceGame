package com.mindsilence.game.presentation.highscores // Highscore Route + Screen: daily list, Back to training.
...
import androidx.hilt.navigation.compose.hiltViewModel // Hilt HighScoresViewModel; no handwritten factory.
import androidx.lifecycle.compose.collectAsStateWithLifecycle // List snapshot.
import com.mindsilence.game.R // strings.
import com.mindsilence.game.domain.model.DailyStats // Preview rows.
...
fun HighScoresRoute( // AppRoute passes onBack; repo comes from Hilt.
    onBack: () -> Unit, // leaveHighScores().
    modifier: Modifier = Modifier, // Host fill.
    viewModel: HighScoresViewModel = hiltViewModel(), // Load getDailyStats in init via UseCase.
    ...
    HighScoresScreen( // Stateless list.
        ...
        onBack = { viewModel.onBack() }, // Top bar Back.
        ...
        topBar = { // Title + Back; not a nav graph.
            TopAppBar( // Material 3 bar.
                ...
                navigationIcon = { // Leading Back.
                    TextButton(onClick = onBack) { // HighScoresViewModel.onBack().
