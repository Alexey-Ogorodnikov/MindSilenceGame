package com.mindsilence.game.presentation.splash // Compose splash that must pixel-match the system splash.
...
import com.mindsilence.game.presentation.theme.MindSilenceTheme // Preview only; runtime splash ignores this theme.
